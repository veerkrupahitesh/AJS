...
import com.example.admin.ajs.activity.SignUpActivity;
import com.example.admin.ajs.customdialog.CustomDialog;
import com.example.admin.ajs.utility.Debug;
                ...
                JsonRequest mPostRequest = new JsonRequest(mRequestMethod, postUrl, mPostParams.toString(),
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        if (volleyError instanceof NetworkError) {
                            ...
                            responseStatus.setError(message);
                            responseStatus.setErrorNumber(1);
                        } else if (volleyError instanceof ServerError) {
                            message = "The server could not be found. Please try again after some time!!";
                            responseStatus.setError(message);
                            responseStatus.setErrorNumber(2);
                        } else if (volleyError instanceof AuthFailureError) {
                            message = "Cannot connect to Internet...Please check your connection!";
                            responseStatus.setError(message);
                            responseStatus.setErrorNumber(3);
                        } else if (volleyError instanceof ParseError) {
                            message = "Parsing error! Please try again after some time!!";
                            responseStatus.setError(message);
                            responseStatus.setErrorNumber(4);
                        } else if (volleyError instanceof TimeoutError) {
                            message = "Connection TimeOut! Please check your internet connection.";
                            responseStatus.setError(message);
                            responseStatus.setErrorNumber(5);
                        }
                        dataObserver.onFailure(mRequestCode, responseStatus);
